...
export function CharacterCard({ character }: CharacterCardProps) {
  ...
  return (
    <Card className="glass overflow-hidden transition-all duration-400 md:hover:scale-102 hover:shadow-lg glow-hover tilt w-full max-w-sm mx-auto">
      ...
      <CardContent className="p-3">
        <img
          src={character.image}
          alt={character.name}
          className="w-full h-36 sm:h-44 md:h-52 object-cover rounded-xl mb-3 shadow-sm transition-transform duration-300 md:hover:scale-101"
        />
